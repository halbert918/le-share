...
public enum ExpResultEnum {
  ...
  private ExpResultEnum(String code, String message, String errorCode) {
    this.code = code;
   ...
   */
  public static ExpResultEnum getByCode(String code) {
    for (ExpResultEnum resultEnum : values()) {
   ...
   * @return ExpResultEnum
   */
  public static ExpResultEnum getByErrorCode(String errorCode) {
    for (ExpResultEnum resultEnum : values()) {
   ...
   * @return List
   */
  public List<ExpResultEnum> getAllEnum() {
    List<ExpResultEnum> list = new ArrayList<>();
    for (ExpResultEnum resultEnum : values()) {
      list.add(resultEnum);
    }
    return list;
